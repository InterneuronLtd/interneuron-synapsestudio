    ...
    public class FormularyEditVMToFormularyAPIProfile : Profile
    {
        public FormularyEditVMToFormularyAPIProfile()
        {
            ...
            CreateMap<FormularyExcipientModel, FormularyExcipientAPIModel>()
                ...
                .ForMember(dest => dest.StrengthUnitDesc, opt => opt.MapFrom(src => src.StrengthUnit != null ? src.StrengthUnit.Name : null));
        }
        ...
        private List<FormularyLookupAPIModel> AssignControlledDrugCategories(FormularyEditModel src)
        {
            ...
            //}
            //return null;
            return src.ControlledDrugCategoryCd != null ? new List<FormularyLookupAPIModel> { new FormularyLookupAPIModel { Cd = src.ControlledDrugCategoryCd, Desc = src.ControlledDrugCategoryDesc } } : null;
        }
