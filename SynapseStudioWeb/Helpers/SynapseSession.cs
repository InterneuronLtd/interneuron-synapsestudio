...
namespace SynapseStudioWeb.Helpers
{
    public class SynapseSession
    {
        ...
        private const string isStudioAdmin = "isStudioAdmin";
        ...
        public static string IsStudioAdmin
        {
            get { return isStudioAdmin; }
        }
        ...
        public static string AllFDBTherapeuticClasses { get; } = "AllFDBTherapeuticClasses";

        public static string ATCLookup { get; } = "ATCLookup";

        public static string BNFLookup { get; } = "BNFLookup";
