    ...
    public partial class FormularyController : Controller
    {
        ...
        private bool GetByCondition(KeyValuePair<string, string> dictItem, string status)
        {
            return status switch
            {
                ...
                //_ => dictItem.Key == "001"
                "001" => dictItem.Key == "001" || dictItem.Key == "003" || dictItem.Key == "004" || dictItem.Key == "006",
                "003" => dictItem.Key == "003" || dictItem.Key == "004" || dictItem.Key == "006",
                "004" => dictItem.Key == "003" || dictItem.Key == "004" || dictItem.Key == "006",
                "006" => dictItem.Key == "006",
                _ => dictItem.Key == "001"
            };
        }
        ...
        public async Task<IActionResult> GetCustomMedTemplatePartial(string formularyVersionId)
        {
            ...
            if (formularyVersionId.IsNotEmpty())
            {
                ...
                var response = await TerminologyAPIService.GetFormularyDetailRuleBound(formularyVersionId, true, token);
